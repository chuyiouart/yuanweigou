...
const AGENT_KNOWLEDGE = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "对教育机构、展览空间和投资人来说，元维构更像一套内容资产化流程，而不是一次性加工。",
    ],
    templates: {
      direct: [
      ...
      investor: [
        "项目壁垒不在单台设备，而在作品判断标准、转译方法、样本数据、权属管理和场景渠道。",
        "这让元维构可以从单件服务扩展到教育批量、展览空间、文创授权和数字档案。",
      ],
    },
  ...
  },
  {
    ...
    templates: {
      ...
      investor: [
        "价格体系不是单一工费，而是由判断、转译、制作、档案、包装、授权边界和后续运营组成。",
        "这使项目可以同时覆盖高客单定制、教育批量和授权分成三类收入。",
      ],
    },
    collect: [
      "作品数量与类型。",
  ...
  },
  {
    ...
    templates: {
      ...
      investor: [
        "权属管理是项目长期价值的一部分。它使样本库不只是作品展示，而可以逐步发展为可授权、可追踪、可分层运营的内容资产池。",
      ],
    },
    collect: [
      "原作者或作品权利方是谁。",
  ...
  },
  {
    ...
    bullets: [
      ...
      "样本表可服务报价、展签、二维码档案、授权池、教育机构样本包和投资人说明。",
    ...
    templates: {
      ...
      investor: [
        "样本表的价值在于把“作品转译能力”变成“可管理的数据资产”。",
        "随着样本增加，平台可以沉淀适配标准、材料经验、价格区间、授权状态和客户场景，从而支撑规模化合作。",
      ],
      onsite: [
  ...
  },
  {
    ...
    title: "投资人与合作方说明",
    category: "投资",
    keywords: ["投资", "投资人", "商业模式", "赚钱", "收入", "壁垒", "护城河", "价值", "融资", "合作方", "平台", "市场", "增长", "规模化"],
    summary:
      "元维构的商业价值不在单次打印，而在作品判断标准、结构转译方法、案例数据库、权属记录、教育/展览/文创场景和授权运营能力。",
    bullets: [
      "收入结构包括一次性转译服务、教育机构批量、展览与空间项目、文创衍生和授权分成。",
      "36 组样本和真实案例用于证明不同作品类型都能进入统一归档和转译流程。",
      "长期壁垒来自转译判断标准、案例数据、版权边界管理、数字档案和渠道场景，而不是某一台机器。",
      "咨询助手本身也可以成为项目展示能力：让用户、机构、展会观众和投资人直接问项目问题。",
    ],
    templates: {
      investor: [
        "元维构可以被理解为“艺术内容进入三维空间与授权运营的基础设施”。",
        "短期收入来自转译服务和机构批量；中期价值来自样本库、教育合作和展览渠道；长期价值来自授权池、数字档案和可复用的转译标准。",
      ],
      direct: [
        "如果给合作方介绍，可以强调三层价值：服务能落地、样本能证明、数据能积累。",
        "它不是只靠单件制作赚钱，而是让作品从一次性图像变成可展示、可归档、可授权的资产。",
      ],
      onsite: [
      "展会现场可以说：我们已经有样本、网站、二维码入口和项目咨询助手，观众扫码就能理解项目并提交作品判断。",
      ],
    },
    collect: [
      "合作方类型：投资、渠道、教育、展览、文创、技术或制造。",
      "对方最关心：收入模型、样本证据、技术壁垒、版权风险、规模化路径还是客户获取。",
      "希望演示的材料：官网、样本数据表、教育专页、虚拟展厅、项目咨询助手。",
    ],
    caution: "投资沟通中应避免承诺未经验证的市场规模、收益率或版权收益，只展示已完成能力、样本证据和可执行路径。",
    links: [
      ["样本数据表", AGENT_LINKS.samples],
      ["授权与分成", AGENT_LINKS.licensing],
      ["虚拟展厅", AGENT_LINKS.gallery],
    ],
    followups: ["这个项目的收入来源有哪些？", "护城河是什么？", "给投资人演示时怎么讲？"],
  },
  {
    id: "exhibition",
    title: "展会扫码与现场咨询",
    ...
    templates: {
      onsite: [
        ...
        "如果你是机构或合作方，建议留下机构类型、数量、用途和联系方式，我们会按场景回复。",
      ],
      direct: [
        "展会使用时，咨询助手的目标不是替代人工洽谈，而是先完成基础解释、分流和留资。",
        "人工可以把时间留给高价值问题：具体作品、合作数量、授权销售、展览项目和投资沟通。",
      ],
      wechat: [
    ...
    collect: [
      "观众身份：个人创作者、家长、教育机构、展览空间、投资或渠道合作方。",
      "咨询目的：了解项目、提交作品、批量合作、现场采购、授权销售或投资沟通。",
  ...
  },
  {
    ...
    templates: {
      ...
      investor: [
        "数字档案使样本库从线下物件变成线上可检索资产，并为授权池、渠道展示和客户转化提供基础。",
      ],
    },
    collect: [
      "是否需要公开网页模型，还是只做内部查看。",
  ...
  },
  {
    ...
    templates: {
      ...
      investor: [
        "空间合作是项目从个人定制走向机构场景的重要路径，它能带来案例背书、渠道曝光和可复用的内容资产。",
      ],
    },
    collect: [
  ...
  },
  {
    ...
    title: "线索收集与人工跟进",
    category: "留资",
    keywords: ["联系", "怎么联系", "表单", "提交", "预约", "客服", "微信", "自动回复", "留资", "跟进", "咨询", "回访", "电话"],
    summary:
      "项目咨询助手适合完成基础解释和线索分流：访客先问问题，再根据身份进入作品判断、教育合作、投资沟通或人工跟进。",
    bullets: [
      "普通访客：引导提交作品图、用途和联系方式。",
      "教育机构：收集机构名称、学生数量、课程主题、交付时间和展示用途。",
      "投资或渠道合作：收集合作类型、关注点和演示材料需求。",
      "展会现场：用二维码完成基础问答，再把高价值咨询导向人工。",
    ],
    templates: {
      direct: [
        "下一步最实用的是把咨询助手的回答和表单连接起来。",
        "用户问完后，如果涉及具体作品、机构批量、报价或授权，就引导他提交表单或留下联系方式。",
      ],
      wechat: [
      ...
      onsite: [
        "现场扫码后，请选择你的身份：个人作品、教育机构、展览空间、投资或渠道合作。",
...
const FALLBACK = {
  ...
  bullets: [
    ...
    "如果是投资或授权问题：我可以先解释项目逻辑，具体条款需要项目负责人确认。",
  ],
  templates: {
    direct: [
      "你可以把问题改成更具体的形式，例如：我是谁、手里有什么作品、想做什么用途、需要多少件、是否公开展示或销售。",
      "这样咨询助手可以把问题分流到作品判断、教育合作、版权授权、价格或投资说明。",
    ],
  },
  collect: COMMON_COLLECT,
  links: [
...
const WELCOME = {
  ...
  category: "欢迎",
  summary:
    "我可以按访客、家长、教育机构、展会观众、投资人和合作方的不同语境回答。你可以问项目介绍、作品判断、价格、版权、教育批量、样本数据、数字档案、展会扫码和下一步合作。",
  bullets: [
    "低风险问题会直接回答，并给出官网入口。",
    "涉及作品适配、授权销售、源文件、最终报价和合同条款时，会提示提交判断或人工确认。",
    "如果你问“怎么在微信回复客户”“给投资人怎么讲”“展会现场怎么介绍”，我会切换成对应话术。",
  ],
  templates: {
    direct: [
  ...
  followups: ["元维构是什么？", "教育机构30个学生怎么合作？", "给投资人演示时怎么讲？"],
};
...
function detectStyle(question) {
  ...
  if (["投资", "商业模式", "融资", "壁垒", "护城河", "收入", "增长", "投资人"].some((word) => q.includes(word))) {
    return "investor";
  }
