...
const WELCOME = {
  ...
  category: "欢迎",
  summary:
    "我可以按访客、家长、教育机构、展会观众和艺术创作者的不同语境回答。你可以问价格报价、单件样本、教育批量、作品判断、版权、样本数据、数字档案、展会扫码和下一步合作。",
  bullets: [
    "低风险问题会直接回答，并给出官网入口。",
    "涉及作品适配、授权销售、源文件、最终报价和合同条款时，会提示提交判断或人工确认。",
    "你可以直接问：单件样本怎么报价、为什么不能直接按图片报价、教育机构 30 个学生可以怎么合作，或者我的作品能不能做成立体作品。",
  ],
  templates: {
    direct: [
  ...
  followups: ["单件样本怎么报价？", "为什么不能直接按图片报价？", "教育机构30个学生怎么合作？"],
};
