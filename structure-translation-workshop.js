const samples = {
  youth: {
    image: "./assets/workshop-art-youth-v2-publish.webp",
    label: "儿童 / 青少年作品",
    result: {
  ...
  artist: {
    image: "./assets/workshop-art-artist-v2-publish.webp",
    label: "艺术家作品",
    result: {
  ...
  institution: {
    image: "./assets/workshop-art-institution-v2-publish.webp",
    label: "机构样本",
    result: {
...
const outputs = {
  keepsake: {
    title: "已生成纪念样本建议",
    actions: [
      ["提交作品判断", "./submit-check.html?source=structure-translation-workshop&output=keepsake"],
      ["查看教育合作", "./education.html?source=structure-translation-workshop&output=keepsake"],
    ],
  },
  edition: {
    title: "已生成收藏版建议",
    actions: [
      ["了解授权模式", "./licensing.html?source=structure-translation-workshop&output=edition"],
      ["提交第一件样本", "./submit-check.html?source=structure-translation-workshop&output=edition"],
    ],
  },
  exhibition: {
    title: "已生成展厅档案建议",
    actions: [
      ["查看数字档案", "./spatial-archive.html?source=structure-translation-workshop&output=exhibition"],
      ["查看虚拟展厅", "./virtual-gallery.html?source=structure-translation-workshop&output=exhibition"],
    ],
  },
};
